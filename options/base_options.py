...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--s1_input_nc', type=int, default=32, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--s1_output_nc', type=int, default=32, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--s2_input_nc', type=int, default=16, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--s2_output_nc', type=int, default=16, help='# of output image channels: 3 for RGB and 1 for grayscale')
