...
def train_sample(sample, transformer_model, psmnet_model,
    ...
    real_img_reproj_loss, real_img_warped, real_img_reproj_mask = 0,0,0
    if isTrain and adv_train:
        psmnet_model.zero_grad()
        ...
        real_pred_disp = pred_disp3
        real_img_reproj_loss, real_img_warped, real_img_reproj_mask = get_reprojection_error(Radv_L, Radv_R, real_pred_disp)
