...
# python -m torch.distributed.launch train_cascade.py --config-file configs/remote_train.yaml --summary-freq 32 --logdir ../train_8_17_cascade/debug --debug --gan-model
