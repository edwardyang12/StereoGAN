...
parser.add_argument('--split-file', type=str, default='/cephfs/datasets/iccv_pnp/real_data_v9/test.txt',
                    metavar='FILE')
parser.add_argument('--data-folder', type=str, default='/cephfs/datasets/iccv_pnp/messy-table-dataset/real_data_v10_temp/')
...
def main():
    ...
    for idx in range(num):
        for direction in ['irL', 'irR']:
            ...
            pattern = get_smoothed_ir_pattern(diff, ks=9, threshold=0.003)
